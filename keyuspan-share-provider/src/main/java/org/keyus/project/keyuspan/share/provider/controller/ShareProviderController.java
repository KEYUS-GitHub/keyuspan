...
public class ShareProviderController {
    ...
    @PostMapping("/save")
    public ShareRecord save (@RequestBody ShareRecord record) {
        return shareRecordService.save(record);
    }

    @PostMapping("/find_all")
    public List<ShareRecord> findAll (@RequestBody ShareRecord record) {
        return shareRecordService.findAll(record);
    }

    @PostMapping("find_by_url")
    public ShareRecord findByUrl (@RequestBody String url) {
        return shareRecordService.findByUrl(url);
    }

    @PostMapping("/find_by_id")
    public ShareRecord findById (@RequestBody Long id) {
